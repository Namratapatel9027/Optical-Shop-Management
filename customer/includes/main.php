...
?>
        ...
        <ul class="login">
          ...
          if(!isset($_SESSION['customer_email'])){
            ...
            { 
                echo '<a href="my_account.php?my_orders" class="login__link">Account Setting</a>';
            }   
?>  
          </li>
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../index.php">
            <img class="logo__img" src="images/logo.jpg" alt="Opticals fashion logotype" width="150" height="25">
          </a>
        </div>
